...
`;var V="/assets/favicon.894e7ace.svg";const W=({children:e})=>a(P,{children:[a("h2",{children:["\xA1Inspirate y busca los mejores ",o("span",{children:"gifts"}),"!"]}),a(F,{children:[o("img",{src:V,className:"Hero_img"}),e]}),o("p",{children:"Resultados de la busqueda"})]}),D=l.section`
  display: flex;
  flex-direction: column;
  width: 100%;
  position: relative;
...
`,te=({src:e,alt:t="gift",href:r="/"})=>o("a",{href:r,target:"_blank",children:o("img",{src:e,alt:t})});const oe=()=>o("svg",{className:"Spinner",children:o("circle",{cx:"70",cy:"70",r:"70"})}),re=()=>{const{state:e}=d.exports.useContext(p),{gifts:t,loading:r,error:i}=k(e);return a(ee,{children:[i&&o("h2",{children:"Houston, we have a problem"}),r&&o(oe,{}),!i&&!r&&!t.length&&o("h2",{children:"Oh raios :c, parece que no hay gifts con este termino. Intenta con otro :3"}),!i&&!r&&t.length&&t.map(n=>o(te,{src:n.images.downsized_medium.url,href:n.url,alt:n.title},n.id))]})},ne={background:"#ffffff",backgroundGrid:"#e7e7e7",border:"#4a1ee3",color:"#4a1ee3"},se={background:"#373737",backgroundGrid:"#212121",border:"#ffffff",color:"#ffffff"},v={darkMode:se,lightMode:ne},ie=z` 
* {
  margin: 0;
...
`;function ae(){const[e,t]=d.exports.useState(!1),r=()=>{t(!e)};return a(L,{theme:e?v.darkMode:v.lightMode,children:[o(ie,{}),a("div",{className:"App",children:[o(N,{handlerTheme:r,theme:e}),o(W,{children:o(J,{})}),o(re,{})]})]})}E.render(o(R.StrictMode,{children:o(Q,{children:o(ae,{})})}),document.getElementById("root"));
